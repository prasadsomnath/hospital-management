...
export default function PatientsView() {
  ...
  return (
    <div
      ...
      data-ocid="receptionist.patients_view"
    >
      {/* ── Header ── */}
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Browse, search, and manage registered patient records
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="h-9 gap-1.5 rounded-lg bg-teal-600 hover:bg-teal-700 text-white font-medium shadow-sm transition-colors"
          >
